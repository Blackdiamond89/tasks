...
DOWNLOAD_URL_INSTALLER_FILE="https://raw.githubusercontent.com/Blackdiamond89/tasks/main/installer.sh"
DOWNLOAD_URL_COMPOSE_FILE="https://raw.githubusercontent.com/Blackdiamond89/tasks/main/docker-compose.yml"
